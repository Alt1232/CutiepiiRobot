...
class Config(object):
    ...
    # REQUIRED
    TOKEN = "5393515983:AAEC2btjfmPriBwKL387qGGnR8Wa6pQ_Hjc"  # Take from @BotFather
    OWNER_ID = (
    ...
    REDIS_URL = "redis://default:OnfDQdUdvC7LxIP84IiiTLTvnwRV3PVh@redis-18191.c266.us-east-1-3.ec2.cloud.redislabs.com:18191"  # needed for afk module, get from redislab
    LOAD = []
    NO_LOAD = []
    WEBHOOK = False
    URL = None
